...
Functions for clinical trials with two continuous co-primary endpoints
...
Functions for clinical trials with two binary co-primary endpoints using
asymptotic normal approximation

- [`ss2BinaryApprox()`](https://gosukehommaex.github.io/twoCoprimary/reference/ss2BinaryApprox.md)
  : Sample Size Calculation for Two Co-Primary Binary Endpoints
...
- [`twoCoprimary2BinaryApprox()`](https://gosukehommaex.github.io/twoCoprimary/reference/twoCoprimary2BinaryApprox.md)
  : Unified Interface for Two Co-Primary Binary Endpoints (Approximate
  Methods)
...
- [`twoCoprimary2BinaryExact()`](https://gosukehommaex.github.io/twoCoprimary/reference/twoCoprimary2BinaryExact.md)
  : Unified Interface for Two Co-Primary Binary Endpoints (Exact
  Methods)
...
Functions for clinical trials with one continuous and one binary
co-primary endpoint

- [`ss2MixedContinuousBinary()`](https://gosukehommaex.github.io/twoCoprimary/reference/ss2MixedContinuousBinary.md)
  : Sample Size Calculation for Two Co-Primary Endpoints: One Continuous
  and One Binary
...
- [`twoCoprimary2MixedContinuousBinary()`](https://gosukehommaex.github.io/twoCoprimary/reference/twoCoprimary2MixedContinuousBinary.md)
  : Unified Interface for Mixed Continuous and Binary Co-Primary
  Endpoints

## Mixed Count and Continuous Endpoints

Functions for clinical trials with one count (negative binomial) and one
...
- [`ss2MixedCountContinuous()`](https://gosukehommaex.github.io/twoCoprimary/reference/ss2MixedCountContinuous.md)
  : Sample Size Calculation for Two Co-Primary Endpoints: One Count and
  One Continuous
- [`power2MixedCountContinuous()`](https://gosukehommaex.github.io/twoCoprimary/reference/power2MixedCountContinuous.md)
  : Power Calculation for Two Co-Primary Endpoints (Count and
  Continuous)
- [`twoCoprimary2MixedCountContinuous()`](https://gosukehommaex.github.io/twoCoprimary/reference/twoCoprimary2MixedCountContinuous.md)
  : Unified Interface for Mixed Count and Continuous Co-Primary
  Endpoints
- [`ss1Count()`](https://gosukehommaex.github.io/twoCoprimary/reference/ss1Count.md)
  : Sample Size Calculation for a Single Count Endpoint (Negative
  Binomial)

## Utility Functions

Helper functions for correlation bounds and design comparisons
...
- [`twoCoprimary`](https://gosukehommaex.github.io/twoCoprimary/reference/twoCoprimary-package.md)
  [`twoCoprimary-package`](https://gosukehommaex.github.io/twoCoprimary/reference/twoCoprimary-package.md)
  : twoCoprimary: Sample Size and Power Calculation for Two Co-Primary
  Endpoints

## Visualization and Output

Methods for displaying and visualizing results

- [`print(`*`<twoCoprimary>`*`)`](https://gosukehommaex.github.io/twoCoprimary/reference/print.twoCoprimary.md)
  : Print Method for twoCoprimary Objects
- [`print(`*`<twoCoprimary_table>`*`)`](https://gosukehommaex.github.io/twoCoprimary/reference/print.twoCoprimary_table.md)
