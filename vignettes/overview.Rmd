...
- The overall power is the joint probability: Power = $\Pr(\text{Reject } {\rm H}_{01} \text{ and Reject } {\rm H}_{02})$
...
We reject ${\rm H}_{0}$ only if **both** ${\rm H}_{01}$ and ${\rm H}_{02}$ are rejected at level $\alpha$.
...
**Decision rule**: Reject ${\rm H}_{0}$ if and only if:
...
$$\alpha_{\text{overall}} = \Pr(\text{Reject } {\rm H}_{0} \mid {\rm H}_{0} \text{ true})$$
...
Under the alternative hypothesis ${\rm H}_{1}$, the overall power is:
...
- $\mu_{1}$ and $\mu_{2}$ are the non-centrality parameters under ${\rm H}_{1}$
