...
- $\text{Var}(\hat{\beta}_{1}) = \frac{1}{n_{2}}\left[\frac{1}{t}\left(\frac{1}{r_{2}} + \frac{1}{r r_{1}}\right) + \frac{1+r}{\nu r}\right] = \frac{V_{a}}{n_{2}}$, where $r_{1}$ and $r_{2}$ are the event rates and $r = n_{1}/n_{2}$ is the allocation ratio
...
- Count rates: $r_{1} = 1$, $r_{2} = 2$, $t = 1$ → $\lambda_{1} = 1$, $\lambda_{2} = 2$
- Dispersion: $\nu = 3$ and $5$
...
- Correlation reduces sample size: about 2 to 3% at $\rho = 0.4$ and 7 to 9% at $\rho = 0.8$
