...
#' sample size determination for two co-primary binary endpoints using
...
#' @param Test Test method: "AN" (asymptotic normal), "ANc" (with continuity
#'   correction), "AS" (arcsine), or "ASc" (arcsine with continuity correction)
#'
...
#'
#' @export
twoCoprimary2BinaryApprox <- function(n1 = NULL, n2 = NULL,
                                      p11, p12, p21, p22,
                                      rho1, rho2,
                                      power = NULL, r = NULL,
                                      alpha = 0.025, Test = "AN") {
